...
Fünf Beteiligte, drei intern, zwei extern.

| Rolle | Intern/Extern | Aufgabe / Interesse | Bereich im Portal | Zugriff |
|---|---|---|---|---|
| **Fahrlehrer** | intern | Fahrstunden abarbeiten, Ausbildungsdiagrammkarte abhaken | „Seine" Schüler + Ausbildung | lesen/schreiben (eigener Bereich) |
...
5. **Verwaltung / Konten & Rollen** _(Chef)_
